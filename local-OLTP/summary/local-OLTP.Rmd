...
ss=subset(aggdata,(Group.2<=1000)&(Group.1 %in% c("mysql55","mysql56","mysql57") ))
#ss=subset(aggdata)
...
#ss=subset(aggdata)
wide_format$`MySQL 55` = wide_format$`mysql55`/wide_format$`mysql57`
wide_format$`MySQL 56` = wide_format$`mysql56`/wide_format$`mysql57`

dat_m <- melt(subset(wide_format), id.vars = "aggdata.Group.2", measure.vars=c("MySQL 55","MySQL 56"))
...
ss=subset(aggdata,(Group.2<=1000)&(Group.1 %in% c("mysql56","mysql56.noSTRO") ))
#ss=subset(aggdata)
...
```{r AHI0, echo=FALSE, warning=FALSE,fig.width=8, fig.height=6}
ss=subset(aggdata,(Group.2<=1000)&(Group.1 %in% c("mysql56","mysql56.AHI0","mysql57","mysql57.AHI0") ))
#ss=subset(aggdata)
