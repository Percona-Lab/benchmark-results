...
for (d in disks) {
    ...
    print(ggplot(aggdata_pareto, aes(x=as.factor(Group.2),y=as.numeric(x),color=as.factor(Group.1),group=Group.1)) + facet_grid(Group.4 ~ Group.3) +geom_line()+geom_point(size=4) + labs(x="Threads",y="Throughput,tps",title=gtitle)+scale_color_tableau(name="Engine")+scale_y_continuous(breaks=extended_range_breaks()(rbind(0,x)),labels = scales::comma)+theme(axis.text.x  = element_text(angle=45, vjust=0.5))+theme_bw() + theme(panel.grid = element_line(colour="#010101",size=1), panel.background = element_rect(colour="#000000"), plot.background = element_rect(colour="#000000"), strip.background = element_rect(colour="#010101"), text=element_text(size=50), strip.text=element_text(size=60)))
    ...
    print(ggplot(aggdata_uniform, aes(x=as.factor(Group.2),y=as.numeric(x),color=as.factor(Group.1),group=Group.1))+geom_line()+geom_point(size=4) + facet_grid(Group.4 ~ Group.3) +labs(x="Threads",y="Throughput,tps",title=gtitle)+scale_color_tableau(name="Engine")+scale_y_continuous(breaks=extended_range_breaks()(rbind(0,x)),labels = scales::comma)+theme(axis.text.x  = element_text(angle=45, vjust=0.5))+theme_bw() + theme(panel.grid = element_line(colour="#010101",size=1), panel.background = element_rect(colour="#000000"), plot.background = element_rect(colour="#000000"), strip.background = element_rect(colour="#010101"), text=element_text(size=50), strip.text=element_text(size=60)))
