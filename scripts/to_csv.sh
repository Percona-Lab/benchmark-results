...
echo "engine,memory,filesystem,configuration,distribution,test,$(env _ONLYHEADER=1 csv_from_sysbench.sh ../raw/memory_scalability/sysbench-mem200-wt-ext4-wt1-pareto-100-oltp.txt _ _ _)" > ../memory_scalability.csv
