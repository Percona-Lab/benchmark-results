...
function thread_init(thread_id)
   ...
   if ( oltp_high_prio ~= '' and oltp_high_prio_set == 'once' ) then 
--      print("High prio mode=" .. oltp_high_prio .. " thread_id=" .. thread_id .. "\n")
      db_query("set session thread_pool_high_prio_mode=" .. oltp_high_prio)
   end
...
--   table_name = oltp_table_name
   ...
   if ( oltp_high_prio ~= '' and oltp_high_prio_set == 'event' ) then 
--      print("High prio mode=" .. oltp_high_prio .. " thread_id=" .. thread_id .. "\n")
      db_query("set session thread_pool_high_prio_mode=" .. oltp_high_prio)
   end
